#!/usr/bin/env python3
"""
IonQ Stress Test Results Retrieval Script
==========================================

Retrieves completed IonQ Forte-1 stress test jobs and processes results.
...
def retrieve_stress_test_jobs():
    ...
    if not os.path.exists(manifest_file):
        ...
        print("Please ensure job_manifest.json exists in the results/ directory.")
        return
    ...
    for job_info in manifest['jobs']:
        ...
        try:
            ...
            result_file = os.path.join(data_dir, f"{exp_name}.h5")
    ...
    print(f"  python plot_ionq_stress_test.py --all")
